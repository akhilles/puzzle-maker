...
def climbing(n=5):
    iters = 5000
    puz, best, tempdata = hill_restarts(n, restarts=1, iters=iters, report=100, p=0.2, temperature=0, decay=0.999)
...
if __name__=='__main__':
    ...
    # puz, best, data = hill_restarts(11, restarts=1, iters=10000, report=100, p=0.2, temperature=0, decay=0)
    ...
    # puz, best, data = hill_restarts(11, restarts=1, iters=10000, report=100, p=0, temperature=100, decay=0.999)
    # print("Basic: ", puz, best)
    # plt.figure()
    # plt.plot(np.arange(0, 10000, 100), data)
    # plt.ylabel('Fitness')
